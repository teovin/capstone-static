		...
		return html`
			...
			<main id="main" class="interiorPage__main">
				...
				<article class="interiorPage__article">
					<h2 class="interiorPage__decorator" id="what-data-do-we-have">
					...
					<p>
						<strong class="interiorPage__purple">APA</strong><br />
						<span>Caselaw Access Project.</span> (2018). Retrieved [date], from
						[url].
					</p>
					<p>
						<strong class="interiorPage__purple">MLA</strong><br />
					...
					<h2 class="interiorPage__decorator" id="usage-and-access">
						Usage and Access
					</h2>
					<p class="interiorPage__purple">
						<strong>
							The CAP data is free for the public to use and access.
						</strong>
					</p>
					<h2 class="interiorPage__decorator" id="press">Press</h2>
					<cap-media-list></cap-media-list>

					<h2 class="interiorPage__decorator" id="friends-and-partners">
