			...
			<main id="main" class="l-interiorPage">
				...
				<article class="u-col-span-3">
					...
					<p>
						...
						published through {{ CASE_MAX_YEAR }}, with new data releases on a
						rolling basis at the beginning of each year.
					</p>
					<p>
					...
					<h2 id="usage-and-access">Usage and Access</h2>
					<p>The CAP data is free for the public to use and access.</p>
					<p>
					...
					<h2 id="getting-legal-help">Getting Legal Help</h2>
					<p>
