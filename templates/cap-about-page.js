		...
		return html`
			...
			<main id="main" class="l-interiorPage">
				...
				<article class="c-article u-bg-beige">
					...
					<h2 class="decoratedHeader" id="data-sources">Data sources</h2>
					...
					<h2 class="decoratedHeader">By the numbers</h2>
					<p>
						Here are some tsv-formatted spreadsheets with specific counts from
						our collection, and links to view those cases in the API:
					</p>
					<ul>
						<li><a href="">Case Count by Reporter Series</a></li>
						<li><a href="">Case Count by Jurisdiction</a></li>
						<li><a href="">Case Count by Decision Date</a></li>
					</ul>
					<h2 class="decoratedHeader" id="data-quality">Data quality</h2>
					<p>
					...
					<h2 class="decoratedHeader" id="data-citation">Data citation</h2>
					<p>
					...
					<h2 class="decoratedHeader" id="usage-and-access">
						Usage and Access
					</h2>
					...
					<h2 class="decoratedHeader" id="press">Press</h2>
					<h2 id="friends-and-partners">Friends and Partners</h2>
					<ul>
						<li>
					...
					<h2 class="decoratedHeader" id="getting-legal-help">
						Getting Legal Help
					</h2>
					<p>
